 ...
 */
if (!localization) {
  console.error("Something went wrong while initializing");
}
...
var LocalizedStrings = (function (_LocalizedStringsCore) {
  ...
  function LocalizedStrings(props) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        LocalizedStrings.__proto__ || Object.getPrototypeOf(LocalizedStrings)
      ).call(this, props, { customLanguageInterface: getInterfaceLanguage }),
    );
  }
