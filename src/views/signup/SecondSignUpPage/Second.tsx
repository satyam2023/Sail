  ...
  return (
    <View style={{flex:1,marginBottom:ScreenHeight*(0.21),paddingHorizontal:20}}>
      ...
      <InputTextField
        ...
        maxlength={20}
        key={Object.keys(roleNameDetails)[0]}
        leftIcon={buttonStatus?Glyphs.ActiveUpn:Glyphs.Contact}
      ...
      <InputTextField
        ...
        maxlength={30}
        key={Object.keys(roleNameDetails)[1]}
        defaultValue={rolenamevalues?.current?.Email}
        leftIcon={buttonStatus?Glyphs.ActiveEmail:Glyphs.Email}
        errors={roleNameErrors.current}
      ...
      <CustomDropDown
        ...
        leftIcon={buttonStatus?Glyphs.ActiveLocation:Glyphs.Location}
      ...
      <CustomDropDown
        ...
        leftIcon={buttonStatus?Glyphs.ActiveRole:Glyphs.Role}
