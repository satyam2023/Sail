    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={{ position: "relative", bottom: 60 }}>
        <HorizontalScrollableList
          ...
          onPress={(id:number,index:number) =>{handleHorizontalScrollableClick(id,index);console.log("????????????")}}
          heading={StringConstants.PRODUCT_CATALOGUE}
          subHeading={StringConstants.VIEW_ALL}
          id={1}
          upperTextPress={(id:number)=>onClickEventOnUpperTextOfHorizontalList(id)}
        />
        <HorizontalScrollableList
          Data={CustomerInformation}
          onPress={(id:number,index:number) =>{handleHorizontalScrollableClick(id,index);console.log("Medium Index:::",index)}}
        ...
        <HorizontalScrollableList
          Data={Category}
          onPress={(id:number,index:number) =>handleHorizontalScrollableClick(id,index)}
